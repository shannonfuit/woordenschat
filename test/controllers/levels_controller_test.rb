...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { closingdate: @level.closingdate, number: @level.number, openingdate: @level.openingdate }
    end
  ...
  test "should update level" do
    patch :update, id: @level, level: { closingdate: @level.closingdate, number: @level.number, openingdate: @level.openingdate }
    assert_redirected_to level_path(assigns(:level))
  end
